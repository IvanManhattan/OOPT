...
namespace Lab1 {
    public class Rectangle : DisplayObject {
        ...
        public Rectangle(Color color, int borderThickness, Color borderColor, 
        ...
        public override void CheckCollision() {
            if (_x + _width >= MainForm.PictureBoxWidth) {
                _x = MainForm.PictureBoxWidth - _width - BorderThickness - 4;
            }
            if (_y + _height >= MainForm.PictureBoxHeight) {
                _y = MainForm.PictureBoxHeight - _height - BorderThickness - 4;
            }
        }
    }
